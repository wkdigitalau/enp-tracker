...
const COMPETENCIES = [
  ...
  { week: 4, title: "Use the resident management system to access and update care plans (with care manager)", phase: "Orientation and Foundations" },
  ...
  { week: 9, title: "Perform wound assessment and basic wound dressing changes — completing correct wound documentation in the resident management system", phase: "Clinical Care and Documentation" },
